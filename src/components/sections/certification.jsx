...
export default function Certification() {
    ...
    <div id="education" className="py-10">
        <h2 data-aos="zoom-in" className="text-center pt-12 pb-6 text-3xl font-bold">MON PARCOURS <spanc className="text-indigo-600">& CERTIFICATS</spanc></h2>
        
        <div className="flex max-md:flex-col gap-8 justify-center items-start px-6 md:px-38">
            <div className="w-full">
                <h2 data-aos="zoom-in" className="font-semibold text-xl">Education</h2>
            ...
            <div className="w-full">
                <h2 data-aos="zoom-in" className="font-semibold text-xl">Expérience</h2>
                <div className="flex flex-col gap-6 border-l-2 border-gray-300 my-8">
